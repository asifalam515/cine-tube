    ...
    return (
      <aside>
				<ul classNameName="space-y-2">
					<li>
						<a classNameName="flex items-center space-x-2 px-5 py-3.5 rounded-lg bg-primary text-black" href="#">
							<img src={Trending} width="24" height="24" alt="" />
							<span>Trending</span>
						</a>
					</li>
					<li>
						<a classNameName="flex items-center space-x-2 px-5 py-3.5 rounded-lg" href="#">
